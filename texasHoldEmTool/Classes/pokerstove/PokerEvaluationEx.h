...
public:
    ...
    //6返5
    static unsigned char FiveFromSix(unsigned char cbHandCardData[],unsigned char cbHandCardCount,unsigned char cbCenterCardData[],unsigned char cbCenterCardCount,unsigned char cbLastCardData[],unsigned char cbLastCardCount);
    
    //7返5
    static unsigned char FiveFromSeven(unsigned char cbHandCardData[],unsigned char cbHandCardCount,unsigned char cbCenterCardData[],unsigned char cbCenterCardCount,unsigned char cbLastCardData[],unsigned char cbLastCardCount);
    
    /**
     * @brief   德州扑克获取最大牌的用户索引数组
     */
    static void maxIdx_Evaluation(unsigned char handCardData[][2], unsigned char curCenterCardData[], int iPlays, int iJoinNum, int *maxIdx);
};
